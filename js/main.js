...
if(page=="page4"){document.getElementById("steps_progress").src="img/progress_44.png";document.getElementById("channel-step").remove();var element=document.getElementById("question");element.innerHTML="";document.getElementById("account-step").style.display="block";}
...
document.getElementById("account-step").remove();document.getElementById("loader").style.display='block';setTimeout(function(){document.getElementById("loader").remove();document.getElementById("steps_progress").src="img/progress_55.png";document.getElementById("final-step").style.display='block';},6000);}
...
var questions=[new Question("هل تلعب ببجي موبايل يوميا ؟",["نعم","لا"]),new Question("ما هو مستواك في اللعبة ؟",["أكثر من 50","أقل من 50"]),new Question("كم عدد شدات ببجي لديك ؟",["أقل من 50","50-100","100-500","أكثر من 500"])];function Quiz(questions){this.questions=questions;this.questionIndex=0;}
...
showProgress();}
else{document.getElementById("steps_progress").src="img/progress_44.png";nextPage("page4");hideProgress();for(var i=0;i<4;i++){document.getElementById("btn"+i).style.display="none";}}
...
function showProgress(){var currQuestNum=quiz.questionIndex+1;if(currQuestNum==2){document.getElementById("steps_progress").src="img/progress_22.png";}
else if(currQuestNum==3){document.getElementById("steps_progress").src="img/progress_33.png";}}
